  ...
  return (
    <div className="signup-container">
      <div className="signup-panel">
        <button
          onClick={() => closeRegisterPanelEvent(true)}
          className="close"
          disabled={loading}
        >
          &times;
        ...
        <div className="logo">
          <img src="/Assets/x-logo.png" alt="Logo" />
        </div>
        <form className="register-section" onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            <div className="input-container">
              ...
              <div className="counter" id="username-counter">
                {username.length} / 32
              </div>
            </div>
            {error && <p className="input-error">{error}</p>}
          ...
          <div className="input-group">
            <div className="input-container">
              ...
              <div className="counter" id="password-counter">
                {password.length} / 64
              </div>
            </div>
            {error && <p className="input-error">{error}</p>}
